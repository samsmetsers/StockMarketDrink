...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('stockmarket', '0008_rename_rode_wijn_stockmarketdrinkinstance_rodewijn_and_more'),
    ]
